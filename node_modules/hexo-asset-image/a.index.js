			...
			if(!/http[s]*.*|\/\/.*/.test(src) &&
			  ...
			  if(link.substring(0,3)=="im1"){
				...
				console.info&&console.info("judement the seventh capture!");
			  	...
			  	console.info&&console.info("NO match!-->:" + link + "data.permalink:" + data.permalink);
			  }

			  //$(this).attr('src', config.root + "image1/" + src);
			  $(this).attr('src', config.root + link + src);
			  console.info&&console.info("update link as:-->root="+config.root + "/imagelink=" + link + "/src=" + src);
			}
		}else{
